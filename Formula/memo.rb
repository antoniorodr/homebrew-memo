class Memo < Formula
  ...
  url 'https://github.com/antoniorodr/memo/releases/download/v0.3.6/memo-0.3.6.tar.gz'
  sha256 'acc259add32195b5ab462cd493f612b43af0d82146ec538199aa3bbd169ceec2'
  license 'MIT'
